...
<head>
    ...
    <script src="../../js/faculty/view_attendacne_complete.js"></script>
            ...
            <div class="container-fluid">
                ...
                <table class="table table-bordered">
                    ...
                    <tr ng-repeat="stu in list.student.marks">
                        ...
                        <td>{{stu.attended}}</td>
                        <td>{{stu.total}}</td>
                        <td ng-if="(stu.attended / stu.total)*100 >= 75">{{(stu.attended / stu.total)*100 | number : 2}}%</td>
                        <td ng-if="(stu.attended / stu.total)*100 < 75" style="color: red">{{(stu.attended / stu.total)*100 | number : 2}}%</td>
                    </tr>
                </table>
            </div>
            <!-- /.container-fluid -->
